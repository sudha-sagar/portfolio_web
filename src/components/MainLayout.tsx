      ...
      >
        <div className={`relative w-full overflow-visible transition-all duration-500 ${
          ...
          <div className="grid grid-cols-12 gap-y-[24px] md:gap-y-[80px] items-start relative z-10">
            ...
            <div className="col-span-12 md:col-span-5 md:col-start-1 md:translate-y-[64px]">
              <EchoFragment 
                perspective={perspective}
            ...
            <div className="col-span-12 md:col-span-5 md:col-start-8 md:-translate-y-[32px]">
              <EchoFragment 
                perspective={perspective}
            ...
            <div className="col-span-12 md:col-span-7 md:col-start-3 md:translate-y-[48px]">
              <EchoFragment 
                perspective={perspective}
            ...
            <div className="col-span-12 md:col-span-5 md:col-start-1 md:translate-y-[32px]">
              <EchoFragment 
                perspective={perspective}
            ...
            {/* Echo 8: Awareness */}
            <div className="col-span-12 md:col-span-5 md:col-start-7 md:translate-y-[16px]">
              <EchoFragment 
                perspective={perspective}
    ...
    <div className="w-full">
      ...
      <section className={`transition-all duration-[0.8s] ease-[cubic-bezier(0.16,1,0.3,1)] grid grid-cols-1 lg:grid-cols-12 gap-[32px] md:gap-[48px] items-center lg:items-start lg:-mt-4 ${
        ...
        <div className="lg:col-span-7 relative z-10 self-center lg:translate-y-[-44px] transition-all duration-[0.8s] ease-[cubic-bezier(0.16,1,0.3,1)]">
          ...
          <p className="max-w-2xl text-[15.5px] text-[#475569] leading-relaxed mb-4">
          ...
          <div className="mt-6 pt-5 border-t border-slate-100/80 flex flex-col gap-4 select-none max-w-xl">
            ...
            <div className="min-h-[64px] flex items-start gap-3.5 p-[14px] bg-white/70 border border-slate-100 rounded-[20px] shadow-[0_4px_20px_rgba(15,23,42,0.015)] backdrop-blur-md">
